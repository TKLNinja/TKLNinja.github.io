...
/*:
 * @plugindesc A base plugin that defines a sprite aggregate object "perch".
 * @author 尾角 つの (Tsuno Ozumi)
 *
 * @param Cursor Position
 * @desc
 * Specify the cursor reference position.(top, bottom, left, right,
 * center, top-left, top-right, bottom-left, bottom-right)
 * @default top-right
 *
 * @param Cursor Offset X
 * @desc The X coordinate of the cursor position is shifted by the value.
 * @default 0
 *
 * @param Cursor Offset Y
 * @desc The Y coordinate of the cursor position is shifted by the value.
 * @default 0
 *
 * @param Cursor Interval
 * @desc Sets the cursor update interval.
 * @default 10
 *
 * @help
 * 
 * Define a perch that can collectively manage sprites, such as image commands.
 * 
